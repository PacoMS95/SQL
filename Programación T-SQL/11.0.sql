...
CREATE FUNCTION devolverNumeroEstaciones (@fecha_i date, @fecha_f date)
RETURNS TABLE AS
RETURN (
select 
)
...
--    Crea una función inline a la que pasemos la matrícula de un tren 
--    y una fecha de inicio y fin y nos devuelva una tabla con el número de veces que ese
--    tren ha estado en cada estación, además del ID, nombre y dirección de la estación
...
--    Crea una función inline que nos diga el número de personas que han pasado por una estacion en un periodo de tiempo. Se considera que alguien ha pasado por una estación si ha entrado o salido del metro por ella. El principio y el fin de ese periodo se pasarán como parámetros
